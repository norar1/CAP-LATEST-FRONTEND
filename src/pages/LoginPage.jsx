      ...
      <div className="bg-white p-8 rounded-lg shadow-lg border-4 border-blue-500 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} autoComplete="on">
          ...
          <div className="flex items-center justify-between">
            <button
              className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full disabled:opacity-50 disabled:cursor-not-allowed"
              type="submit"
              disabled={loading}
            >
